...
void main() {
  group('gg_periodic_timer_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_periodic_timer_version.dart');
